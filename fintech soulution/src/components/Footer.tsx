...
const links = {
  ...
  Resources: ['Help Center', 'Documentation', 'API Reference', 'Changelog'],
        ...
        <div className="py-14 grid grid-cols-2 md:grid-cols-6 gap-10">
          ...
          <div className="col-span-2">
            ...
            <div className="flex gap-2">
              {/* Twitter/X */}
              <SocialIcon path="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-4.714-6.231-5.401 6.231H2.74l7.73-8.835L1.254 2.25H8.08l4.26 5.632 5.905-5.632zm-1.161 17.52h1.833L7.084 4.126H5.117z" />
              {/* LinkedIn */}
          ...
          {Object.entries(links).map(([group, items]) => (
            <div key={group}>
              <h4 className="text-xs font-bold text-slate-300 uppercase tracking-wider mb-4">{group}</h4>
