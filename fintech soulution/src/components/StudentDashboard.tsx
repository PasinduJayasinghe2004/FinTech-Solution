...
export default function StudentDashboard({ 
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex font-sans antialiased text-slate-900">
      ...
      {/* Left Sidebar */}
      <aside className="w-64 bg-white border-r border-slate-100 p-6 flex flex-col justify-between shrink-0 hidden md:flex min-h-screen">
        <div>
          {/* Logo */}
          <div className="flex items-center gap-3 mb-8">
            ...
            <span className="font-display font-bold text-xl tracking-tight text-slate-900">TuitionPay</span>
          </div>
        ...
        <div className="pt-6 border-t border-slate-100 space-y-1.5">
          ...
          <button
            onClick={onLogout}
            className="w-full flex items-center gap-3 px-3.5 py-2.5 rounded-xl text-sm font-semibold text-red-500 hover:bg-red-50 transition-colors cursor-pointer"
          >
            <span>🚪</span>
            <span>Logout</span>
          </button>
